...
class SystemTrayIcon(QtWidgets.QSystemTrayIcon):
    ...
    def __init__(self, icon, parent=None):
        ...
        open_app.setIcon(QtGui.QIcon("media/icon.png"))

        open_cal = menu.addAction("Open Calculator")
        open_cal.triggered.connect(self.open_calc)
        open_cal.setIcon(QtGui.QIcon("media/icon.png"))

        exit_ = menu.addAction("Exit")
        exit_.triggered.connect(lambda: sys.exit())
        exit_.setIcon(QtGui.QIcon("media/icon.png"))
    ...
    def open_calc(self):
        ...
        :return:
        """
        os.system('Kalkulator')


def main():
    app = QtWidgets.QApplication(sys.argv)
    w = QtWidgets.QWidget()
    tray_icon = SystemTrayIcon(QtGui.QIcon("media/small_logo.png"), w)
    tray_icon.show()
